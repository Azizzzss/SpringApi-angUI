...
import com.example.Apiformation.auth.AuthErrrResponse;
...
public class AuthenticationService {
    ...
    public Object register(RegisterRequest request) {
       var f = userRepo.findByUsername(request.getUsername()) ;

        if( f != null ){
            var Err = "username already exists";
            return AuthErrrResponse.builder().usernameNF(Err).build() ;
        }
